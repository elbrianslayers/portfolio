  ...
  const projects = [
    {
      ...
      description: 'A few different react components I made for class. It includes things like a navigation bar, a signup form, and widgets to show my skills and work experience.',
      link: 'https://github.com/Ensign-College/cs220-cc-09-elbrianslayers',
      logo: '/react-icon.png',
    },
    {
      name: 'Dark Mode Theme Switcher',
      description: 'A simple button that lets you switch a website between light and dark mode. This assignment helped me figure out how to use React state and Tailwind CSS together.',
      link: 'https://github.com/Ensign-College/cs220-cc-16-elbrianslayers.git',
      logo: '/react-icon.png',
    },
    {
      name: 'JavaScript Taxes Challenge',
      description: 'One of my first JavaScript challenges. It calculates taxes based on different variables. It was really good practice for learning basic JavaScript logic and working with arrays.',
       ...
       {/* tittle and intro */}
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Some of the projects I've built while learning to code.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I'm currently taking the CS 220 Web Development class, and these are some of the assignments I've been working on. I've been learning how to go from basic HTML and JavaScript to building actual interfaces using React and Tailwind CSS.
          </p>
        </div>
